...
const api_key = "7b03ae7cf7502f31371d10661a185f8b";
...
.then(res => res.json())
.then(data => {
    let contaner =document.querySelector('.recommendations-container');
    for(let i = 0; i < 16; i++){
        ...
        <div class="movie" onclick="location.href = '/${data.results[i].id}'">
            <img src="${img_url}${dta.results[i].backdrop_path}" alt="">
